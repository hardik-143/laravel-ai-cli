...
use LaravelAiCli\Ai\Agents\RefactorAgent;

class RefactorCommand extends Command
{
    protected $signature = 'ai:refactor {file}';
    protected $description = 'Refactor code for better quality and maintainability';
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $response = app(RefactorAgent::class)->prompt(
